...
- `skills/exposing-services.md` documents how to make any file/service you run reachable from outside this Space (bind it to a port 1024-65535, it's automatically reachable at `/<port>/` — no nginx config change needed). Read it whenever asked to run something "on port N".
